 ...
 *
 * なぜ作るのか:
 *   税理士事務所への挨拶回りで渡すカードのQRの飛び先。先生が顧問先へ持っていける「手土産」を
 *   前に出す。すなわち、決算や試算表から助成金の芽を見つけてご提案できること、そして
 *   ご紹介いただいた場合は成功報酬を顧問先と同じ15％でお引き受けすること。
 *   あわせて「自分の業務に食い込まれないか」への答え（業務範囲の線引き）を置く。
 *
...
<section class="sec">
  <div class="w">
    <div class="sec-head rv">
      <div class="sec-head-idx"><span class="idx-lat">SUBSIDY</span><span class="idx-jp">助成金のご提案</span></div>
      <div class="sec-head-body">
        <h2 class="sec-h">数字を見ている先生だからこそ、<strong>気づける入口があります。</strong></h2>
        <p class="sec-sub">雇用関係助成金は「取り組む前に出す書類」が要件になっているものがほとんどで、動いたあとでは間に合いません。決算や月次で顧問先の動きに最初に触れるのは、先生です。</p>
      </div>
    </div>

    <div class="pt-two rv">
      <div class="pt-card yes">
        <h3>こんな話が出たら、助成金の芽です</h3>
        <ul class="pt-list">
          <li>「パートを正社員にしようと思う」→ キャリアアップ助成金（<b>転換の前に</b>計画書）</li>
          <li>「設備を入れたい」「最低賃金が上がってつらい」→ 業務改善助成金（申請が先、発注は後）</li>
          <li>「社員が産休に入る」→ 両立支援等助成金（<b>育休が始まる前に</b>面談とプラン）</li>
          <li>「人を採りたい」→ トライアル雇用・特定求職者雇用開発助成金</li>
          <li>「研修を受けさせたい」→ 人材開発支援助成金（先に計画届）</li>
        </ul>
        <p class="pt-note">いずれも順序を外すと、同じことをしても対象になりません。話が出た時点でお知らせいただければ、間に合う形をお示しします。</p>
      </div>
      <div class="pt-card">
        <h3>富山県には、上乗せがあります</h3>
        <ul class="pt-list">
          <li>賃上げ応援補助金 ── 国の助成金の申請を社労士へ依頼した費用の一部を県が補助（中小2分の1・小規模3分の2／上限10万円）</li>
          <li>賃上げサポート補助金 ── 業務改善助成金への設備費の上乗せ</li>
          <li>男性の育児休業取得促進補助金 ── 連続5日以上5万円・1か月以上10万円・3か月以上20万円</li>
        </ul>
        <p class="pt-note">国と県を同時に使う場合は、併給の可否を事前に各窓口へ確認します。資料室にPDFを置いていますので、顧問先へそのままお渡しいただけます。</p>
      </div>
    </div>
  </div>
</section>
