...
(async () => {
  ...
  for (const width of [360, 390, 1440]) {
    ...
    const resetBlogOk =
      ...
      resetBlogState.count === '全39件' &&
      resetBlogState.visible === 39 &&
  ...
  const expectedTemplateFragments = [
    ...
    'skin-v2.css?v=20260804-hero-cm2',
  ...
  if (generatedBlogState.count !== 40 || generatedBlogState.rows !== 40 || !generatedBlogState.systemRow) {
